document.addEventListener("DOMContentLoaded", function ()
{
	...
	let noteColor = localStorage.getItem("note-color") || null; // Stores the selected note color from the form.

	// TODO: Load the note ID counter from the local storage.
	let noteIdCounter = localStorage.getItem("note-counter") || 0; // Counter for assigning unique IDs to new notes.
	...
	// function to load notes to the page.
	function loadNotes ()
	{
	...
	function addNewNote ()
	{
		...
		localStorage.setItem('note-counter', noteIdCounter);
